    ...
    <footer className="footer">
          ...
          <section>
            <div className="subscribe_container">
              <div className="subscribe_text">
                ...
                <h4 className="subscribe_subtitle">
              ...
              <div className="subscribe_form">
                ...
                />
                <a className="subscribe_form_button" href="#">
                  Subscribe
                </a>
              </div>
            </div>
      ...
      <section>
        <div className="contacts center">
          <p className="copyright_text">© 2024 Brand All Rights Reserved.</p>
          <div className="social_nets_bar">
            <div className="social_net_item">
              <HandySvg
                src={social_net_link1}
                className="social_net_link"
                width="13"
                height="16"
              />
            </div>
